...
//         >
//           <div
//             className="relative bg-gray-900 rounded-xl shadow-2xl w-[90%] max-w-3xl mx-auto my-8 overflow-hidden"
...
//                   src={selectedProject.image}
//                   alt={selectedProject.title}
//                   className="lg:w-full w-[95%] max-h-[70vh] object-contain rounded-xl shadow-2xl"
//                 />
//               </div>
